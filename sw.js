const C='athub-shell-v1-0';
const A=['./','index.html','hub.css','translogistik.html','privat.html','projekte-wissen.html','siggi.html','einstellungen-hub.html','finanzen.html','styles.css','app.js','finance-core-v8.8.1.js','finance-ui-v8.9.js','config.json','manifest.webmanifest','arbeitszeit.html'];
